...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label for="tax_option">Tax Option</label><br>
                <label>
                    <input type="radio" name="tax_option" value="10" <?php echo e(old('tax_option', config('settings.tax_option')) === '10' ? 'checked' : ''); ?>>
                    10% VAT
                </label><br>
                <label>
                    <input type="radio" name="tax_option" value="2" <?php echo e(old('tax_option', config('settings.tax_option')) === '2' ? 'checked' : ''); ?>>
                    2% TOT
                </label><br>
                <label>
                    <input type="radio" name="tax_option" value="10" <?php echo e(old('tax_option', config('settings.tax_option')) === '10' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Natnael\Desktop\POS-Laravel\resources\views/settings/edit.blade.php ENDPATH**/ ?>