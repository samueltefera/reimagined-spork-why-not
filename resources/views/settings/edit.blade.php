    ...
    <div class="card-body">
        <form action="{{ route('settings.store') }}" method="post">
            ...
            <div class="form-group">
                ...
                <label>
                    <input type="radio" name="tax_option" value="10" {{ old('tax_option', config('settings.tax_option')) === '10' ? 'checked' : '' }}>
                    10% VAT
                </label><br>
                <label>
                    <input type="radio" name="tax_option" value="2" {{ old('tax_option', config('settings.tax_option')) === '2' ? 'checked' : '' }}>
                    2% TOT
                </label><br>
                <label>
                    <input type="radio" name="tax_option" value="10" {{ old('tax_option', config('settings.tax_option')) === '10' ? 'checked' : '' }}>
