    ...
    <div class="card-body">
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="purchasing_price" class="form-control @error('purchasing_price') is-invalid @enderror" id="purchasing_price"
                    placeholder="Enter purchasing_price" value="{{ old('purchasing_price', $product->purchasing_price) }}">
